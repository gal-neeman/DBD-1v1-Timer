		...
		case WM_COMMAND:
		{
			...
			case MENU_SETTINGS:
				if (pSettingsWindow->window() == nullptr) // dont create multiple settings windows
				{
					...
					if (!pSettingsWindow->create(L"Settings - Version 1.4.6", 500, 200, SIZE_SETTINGS_WIDTH, SIZE_SETTINGS_HEIGHT, 0, WS_OVERLAPPED | WS_CAPTION | WS_MINIMIZEBOX, hwnd_, nullptr	, nullptr, nullptr)) {
						return 0;
					}
